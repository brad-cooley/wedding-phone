...
class AudioRecording(object):
    ...
    def audio_test(self):
        ...
        logging.info("Finshed recording")
...
if __name__ == "__main__":
    ...
    print(audio_recording.get_id_as_str())
    print(audio_recording.get_filepath_as_str())
    print(audio_recording.get_filename_as_str())
    
    audio_recording.audio_test()